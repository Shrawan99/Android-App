...
public class Mun_services_activity extends AppCompatActivity {
    WebView webView;
    String Url = "http://thorimun.gov.np/mun-services_app";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = Mun_services_activity.this;
        setContentView(R.layout.activity_mun_services);
