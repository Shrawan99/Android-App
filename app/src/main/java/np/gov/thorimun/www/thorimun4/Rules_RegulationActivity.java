...
public class Rules_RegulationActivity extends AppCompatActivity {
    WebView webView;
    String Url = "http://thorimun.gov.np/act-law-directives_app";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = Rules_RegulationActivity.this;
